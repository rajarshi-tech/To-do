    ...
    <>
      ...
      <div className='flex justify-between items-center bg-secondary-1/30 backdrop-blur-md sticky top-0 z-50'>
        ...
        <div className="flex items-center">
          ...
          <Link href='/' className={`${mPlusRounded1c.className} block cursor-pointer mx-1.5 my-2 font-black text-4xl p-2 text-primary-1`}>
            Todo
          </Link>
        </div>
        ...
        <div className="relative">
          ...
          {/* user icon */}
          <div className="bg-secondary-1/80 backdrop-blur-sm p-2 mx-4 rounded-full cursor-pointer transition-all duration-200
